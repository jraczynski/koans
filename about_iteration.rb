...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # A: Combines all elements of a collection in a manner specified by a block
    #    and with an initial value given as a parameter to inject
  end
  ...
  # A: You can give a folder path instead of a single file?
